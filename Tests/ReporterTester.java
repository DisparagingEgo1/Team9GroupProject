...
public class ReporterTester {
    ...
    private static LinkedList<String> generateBadStrings(){
        LinkedList<String>arguments = new LinkedList<>();
        arguments.add("CREATE REPORTER CHANGE R1 NOTIFY ID MYACTUATOR1 MYACTUATOR2 GROUPS MYGROUP3 MYGROUP4 DELTA 4 DELTA");
        ...
        arguments.add("CREATE REPORTER CHANGE R1 NOTIFY ID MYACTUATOR1 MYACTUATOR2 GROPS MYGROUP3 MYGROUP4 DELTA 4");

...
public class ActuatorTester {
    ...
    private static LinkedList<String> generateInvalidStrings() {
        ...
        arguments.add("CREATE ACTUATOR LINEAR A1 GROUPS G1 G2SENSORS S1 S2 ACCELERATION LEADIN 12.0 LEADOUT -14.0 RELAX 3.0 VELOCITY LIMIT 4 VALUE MIN 0 MAX 100 INITIAL 5 JERK LIMIT 3.0");
        arguments.add("CREATE ACTUATOR LINEAR A1 GROUPS G1 G2 SENSORSS1 S2 ACCELERATION LEADIN 12.0 LEADOUT -14.0 RELAX 3.0 VELOCITY LIMIT 4 VALUE MIN 0 MAX 100 INITIAL 5 JERK LIMIT 3.0");
        ...
        arguments.add("CREATE ACTUATOR LINEAR A1 GROUPS G1 G2 SENSORS S1 S2 ACCELERATIONLEADIN 12.0 LEADOUT -14.0 RELAX 3.0 VELOCITY LIMIT 4 VALUE MIN 0 MAX 100 INITIAL 5 JERK LIMIT 3.0");

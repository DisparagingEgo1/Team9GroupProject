...
public class WatchdogTester {
    ...
    private static LinkedList<String> getInvalidArguments(){
        ...
        arguments.add("CREATE WATCHDOG ACCELERATION W1 MODE AVERAGE THRESHOLD LOW 1 HIGH 1 GRACE ");
        ...
        //Band Instantaneous
        arguments.add("CREATE WATCHDOG BAND W1 MODE INSTANTANEOUS THRESHOLD LOW 0 HIGH 1 GRACE  ");
        ...
        //Band Average
        arguments.add("CREATE WATCHDOG BAND W1 MODE AVERAGE THRESHOLD LOW 1 HIGH 2 GRACE ");

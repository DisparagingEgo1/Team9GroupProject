...
public class MapperTester {
    ...
    @ValueSource(strings = {"REATE MAPPER M1 INTERPOLATION SPLINE DEFINITION \"MAPFILE.map\"","CREATE MPPER M1 EQUATION SCALE 1.0 ","CREATE MAPPER EQUATION NORMALIZE 1.0 2.0 ","CREATE MAPPER M1 INTERPOLATION LINEAR DEFINITION MAPFILE.map "
    ,"CREATE MAPPER M1 INTERPOLATION SPLINE DEFINITION","CREATE MAPPER M1 EQUATION NORMALIZE 1.0 ","CREATE MAPPER M1 EQUATION ","CREATE"})

...
public class MapperTester {
    ...
    ,"CREATE MAPPER M1 INTERPOLATION SPLINE DEFINITION","CREATE MAPPER M1 EQUATION NORMALIZE 1.0 ","CREATE MAPPER M1 EQUATION ","CREATE","CREATE MAPPER M1 EQUATION SCALE","CREATE MAPPER M1 EQUATION NORMALIZE 1.0 2.0 bad Text"})
